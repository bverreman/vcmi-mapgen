...
# Gate-only logic (place_gates/mine_gate_stats/GATE_ANIM) and the shared footprint-fitting
# helpers it needs (_cells/_fits/GAP/rnd_monster) live in steps/gate/gates.py now — re-exported
# here so place_zone (below) and legacy callers (pp_map.py) keep working unchanged.
