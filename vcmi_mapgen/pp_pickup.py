...
# place_scatter/_place_one/_web_dist now live in steps/pickup/scatter.py; place_loot_zones/
# _solo_visit_pool/_shrine_spell_level in steps/pickup/loot_zones.py (Pickup is the first
# step in pipeline order to need them) — re-exported here for this module's own remaining
# callers (place_pocket_caches/place_seer_hut_quests/place_pickups stay here until Repair's
# own caches.py move in a later phase).
